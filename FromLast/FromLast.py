...
def from_last(linked_list, index):
    slow = linked_list.get_first()
    fast = linked_list.get_first()
...
class FromLastTest(unittest.TestCase):
    def test_from_last(self):
        ...
        self.assertEqual('b', from_last(linked_list, 3).data)
